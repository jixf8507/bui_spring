					...
					c.validator,
					{
						...
						prototype : {
							init : function() {
								...
								c(this.currentForm)
										.validateDelegate(
												"[type='text'], [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='phone'],[type='idcard'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ",
						...
						methods : {
							...
							phone : function(a, b) {
								return this.optional(b)
										|| /^1[0-9][0-9]\d{8,8}$/.test(a)
							},
							idcard : function(a, b) {
								return this.optional(b)
										|| /(^\d{15}$)|(^\d{17}(\d|x)$)/.test(a)
							},
							url : function(a, b) {
								return this.optional(b)
