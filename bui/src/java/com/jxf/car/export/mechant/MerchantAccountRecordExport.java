...
public class MerchantAccountRecordExport extends BaseExport {
	...
	public static void createExcel(HttpServletResponse response,
		...
		BaseExport be = new MerchantAccountRecordExport();
	...
	protected void writeTile() throws Exception {
		...
		Label label = new Label(0, 0, "商家账户交易明细列表", wffBold);
	...
	protected void writeHeader() throws Exception {
		...
		wsheet.addCell(new Label(column++, 1, "商家登录号", wctB));
	...
	protected String fileName() {
		String filename = "商家账户交易明细列表.xls";
		try {
