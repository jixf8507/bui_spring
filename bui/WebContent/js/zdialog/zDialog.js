 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = contextPath +'/js/zdialog/images/'; //图片路径配置
...
Dialog.prototype.addButton = function (id, txt, func) {
    ...
    button.type = "button";
    button.style.cssText = "margin-right:3px;background: url("+IMAGESPATH+"buticon.gif) no-repeat left top;width: 64px;height: 22px;line-height: 22px;color: #369;text-align: center;border: 0;font-size: 12px;"; 
    button.value = txt;
    button.onclick = func;
