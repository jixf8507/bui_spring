...
public class MerchantGoodsExport extends BaseExport {
	
	public static void createExcel(HttpServletResponse response,
			List<Map<String, Object>> list) throws Exception {
		BaseExport be = new MerchantGoodsExport();
	...
	protected void writeTile() throws Exception {
		...
		Label label = new Label(0, 0, "商品信息列表", wffBold);
